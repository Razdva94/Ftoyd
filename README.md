# Проект: Тестовое задание. Компания "FTOYD"
...
Код написан под экраны 1920 без адаптива, учитывайте пожалуйста это при запуске и сразу настройте панель разработчика под этот вью.
## Запуск проекта
